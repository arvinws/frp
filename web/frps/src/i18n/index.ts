...
const messages = {
  'en-US': {
    ...
    governance: {
      ...
      confirmEnableProxy: 'Are you sure to enable this proxy? It will be allowed to register on next client reconnection.',
  ...
  'zh-CN': {
    ...
    governance: {
      ...
      confirmEnableProxy: '确定要启用该代理吗？客户端重连后该代理将恢复注册。',
